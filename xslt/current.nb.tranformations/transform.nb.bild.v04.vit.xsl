...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="linkurl856ansichtsbild" select="'http://www.helveticarchives.ch/bild.aspx?VEID=XXX&amp;DEID=10&amp;SQNZNR=1'" />
    ...
    <xsl:template name="Linking">
        <xsl:variable name="cdF830w">
            ...
            <xsl:variable name="recordid" select="'0'" />
        ...
        <xsl:choose>
            <xsl:when test="$type = 'foto'">
                ...
                <marc:datafield tag="898" ind2=" " ind1=" " >
                    ...
                    <marc:subfield code="b"><xsl:text>XM020453</xsl:text></marc:subfield>
            ...
            <xsl:when test="$type = 'bild'">
                ...
                <marc:datafield tag="898" ind2=" " ind1=" " >
                    ...
                    <marc:subfield code="b"><xsl:text>XM020353</xsl:text></marc:subfield>
                    <marc:subfield code="c"><xsl:text>XM020000</xsl:text></marc:subfield>
                </marc:datafield>
            </xsl:when>
            <xsl:when test="$type = 'monographie'">
