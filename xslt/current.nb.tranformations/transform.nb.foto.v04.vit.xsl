...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="DataElement[@ElementName='Archivalienart']">
        ...
        <xsl:variable name="farbe" select="following-sibling::DataElement[@ElementName='Farbe']/ElementValue/TextValue/text()"/>
        <xsl:variable name="bildmasse" select="following-sibling::DataElement[@ElementName='Standard Bildformat']/ElementValue/TextValue/text()"/>
